...
function useIsHydrated() {
  return React24.useSyncExternalStore(emptySubscribe, getSnapshot, getServerSnapshot);
}
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime4.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime4.jsxs)(React26.Fragment, {
...
var ChartsSvgLayer = React28.forwardRef(function ChartsSvgLayer2(inProps, ref) {
  const {
    store
  } = useChartsContext();
  ...
  return (0, import_jsx_runtime8.jsxs)(ChartsSvgLayerStyles, _extends({
    viewBox: `0 0 ${svgWidth} ${svgHeight}`,
    className: clsx_default(classes.root, className)
  }, other, {
    ref,
    "aria-hidden": true,
    children: [(0, import_jsx_runtime8.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
function useRegisterPointerInteractions() {
  ...
  const store = useStore2();
  const interactionActive = React29.useRef(false);
  const lastItemRef = React29.useRef(void 0);
  React29.useEffect(() => {
    const element = chartsLayerContainerRef.current;
    if (!element) {
      return void 0;
...
function ChartsAccessibilityProxy() {
  ...
  const chartId = useChartId2();
  const currentFormatRef = React30.useRef(null);
  const currentIndexRef = React30.useRef(0);
...
var _excluded5 = ["children", "title", "desc", "className"];
...
var ChartsLayerContainer = React31.forwardRef(function ChartsLayerContainer2(inProps, ref) {
  const {
    store,
    instance
  } = useChartsContext();
  ...
  return (
    ...
    (0, import_jsx_runtime10.jsxs)(ChartsLayerContainerDiv, _extends({
      ref: handleRef,
      ownerState: {
        width: propsWidth,
        height: propsHeight
      ...
      children: [isKeyboardNavigationEnabled && (0, import_jsx_runtime10.jsx)(ChartsAccessibilityProxy, {}), desc && (0, import_jsx_runtime10.jsx)("span", {
        id: descId,
        style: {
          display: "none"
        },
...
var _excluded6 = ["children", "className", "title", "desc"];
var ChartsSurface = React32.forwardRef(function ChartsSurface2(inProps, ref) {
  const themeProps = useThemeProps({
    props: inProps,
  ...
  const classes = useUtilityClasses2();
  return (0, import_jsx_runtime11.jsx)(ChartsLayerContainer, {
    className: clsx_default(classes.root, className),
    ref,
    title,
    desc,
    children: (0, import_jsx_runtime11.jsx)(ChartsSvgLayer, _extends({}, other, {
      children
    }))
  });
});
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-Y7LTAUMB.js.map
