...
} from "./chunk-WVXXNBKT.js";
import {
  createSimplePaletteValueFilter
} from "./chunk-ZCZEJAIJ.js";
import "./chunk-VPJMGHLD.js";
import {
  chainPropTypes,
  useForkRef
} from "./chunk-ZIQNYRTD.js";
import {
  alpha,
  capitalize_default,
  clsx_default,
...
var MobileStepper = React3.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime3.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [backButton, variant === "text" && (0, import_jsx_runtime3.jsxs)(React3.Fragment, {
      children: [activeStep + 1, " / ", steps]
    }), variant === "dots" && (0, import_jsx_runtime3.jsx)(DotsSlot, {
      ...dotsSlotProps,
      children: [...new Array(steps)].map((_, index) => (0, import_jsx_runtime3.jsx)(DotSlot, {
        ...dotSlotProps,
        className: clsx_default(classes.dot, dotSlotProps.className, index === activeStep && classes.dotActive),
        dotActive: index === activeStep
      }, index))
    }), variant === "progress" && (0, import_jsx_runtime3.jsx)(ProgressSlot, {
      ...progressSlotProps
    }), nextButton]
  });
});
true ? MobileStepper.propTypes = {
  ...
  slotProps: import_prop_types3.default.shape({
    dot: import_prop_types3.default.oneOfType([import_prop_types3.default.func, import_prop_types3.default.object]),
    dots: import_prop_types3.default.oneOfType([import_prop_types3.default.func, import_prop_types3.default.object]),
  ...
  slots: import_prop_types3.default.shape({
    dot: import_prop_types3.default.elementType,
    dots: import_prop_types3.default.elementType,
