...
var require_use_sync_external_store_shim_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      var React33 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState3 = React33.useState, useEffect13 = React33.useEffect, useLayoutEffect = React33.useLayoutEffect, useDebugValue = React33.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
...
var require_with_selector_development = __commonJS({
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js"(exports) {
    ...
    (function() {
      ...
      "undefined" !== typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ && "function" === typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(Error());
      var React33 = require_react(), shim = require_shim(), objectIs = "function" === typeof Object.is ? Object.is : is2, useSyncExternalStore3 = shim.useSyncExternalStore, useRef12 = React33.useRef, useEffect13 = React33.useEffect, useMemo6 = React33.useMemo, useDebugValue = React33.useDebugValue;
...
var useChartDimensions = ({
  ...
  const stateRef = React6.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const [innerWidth, setInnerWidth] = React6.useState(0);
  const [innerHeight, setInnerHeight] = React6.useState(0);
  const computeSize = React6.useCallback(() => {
  ...
  const isXInside = React6.useCallback((x2) => x2 >= drawingArea.left - 1 && x2 <= drawingArea.left + drawingArea.width, [drawingArea.left, drawingArea.width]);
  const isYInside = React6.useCallback((y2) => y2 >= drawingArea.top - 1 && y2 <= drawingArea.top + drawingArea.height, [drawingArea.height, drawingArea.top]);
  const isPointInside = React6.useCallback((x2, y2, targetElement) => {
...
var selectorChartsTooltipItemPosition2 = createSelectorMemoized(selectorChartsTooltipItem, selectorChartDrawingArea, selectorChartSeriesConfig, selectorChartSeriesProcessed, selectorChartSeriesLayout, selectorChartsTooltipAxisConfig, function selectorChartsTooltipItemPosition3(identifier, drawingArea, seriesConfig, series, seriesLayout, axesConfig, placement) {
  var _a2, _b, _c;
  if (!identifier) {
    return null;
  }
...
var useChartInteractionListener = ({
  ...
  const registerGestures = React13.useCallback((gestures) => {
    const svg = chartsLayerContainerRef.current;
    const gestureManager = gestureManagerRef.current;
    if (!gestureManager || !svg) {
      return () => {
...
function cornerTangents(x0, y0, x1, y1, r1, rc, cw) {
  var x01 = x0 - x1, y01 = y0 - y1, lo = (cw ? rc : -rc) / sqrt3(x01 * x01 + y01 * y01), ox = lo * y01, oy = -lo * x01, x11 = x0 + ox, y11 = y0 + oy, x10 = x1 + ox, y10 = y1 + oy, x00 = (x11 + x10) / 2, y00 = (y11 + y10) / 2, dx = x10 - x11, dy = y10 - y11, d2 = dx * dx + dy * dy, r = r1 - rc, D2 = x11 * y10 - x10 * y11, d = (dy < 0 ? -1 : 1) * sqrt3(max2(0, r * r * d2 - D2 * D2)), cx0 = (D2 * dy - dx * d) / d2, cy0 = (-D2 * dx - dy * d) / d2, cx1 = (D2 * dy + dx * d) / d2, cy1 = (-D2 * dx + dy * d) / d2, dx0 = cx0 - x00, dy0 = cy0 - y00, dx1 = cx1 - x00, dy1 = cy1 - y00;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon)) context.moveTo(0, 0);
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da, da1 = da, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon && (padRadius ? +padRadius.apply(this, arguments) : sqrt3(r0 * r0 + r1 * r1)), rc = min2(abs(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t03, t13;
      if (rp > epsilon) {
      ...
      if (rc > epsilon) {
        ...
        if (da < pi) {
          if (oc = intersect(x01, y01, x00, y00, x11, y11, x10, y10)) {
            var ax = x01 - oc[0], ay = y01 - oc[1], bx = x11 - oc[0], by = y11 - oc[1], kc = 1 / sin(acos((ax * bx + ay * by) / (sqrt3(ax * ax + ay * ay) * sqrt3(bx * bx + by * by))) / 2), lc = sqrt3(oc[0] * oc[0] + oc[1] * oc[1]);
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime3.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index2) => {
      ...
      return (0, import_jsx_runtime3.jsxs)(React24.Fragment, {
  ...
  return (0, import_jsx_runtime6.jsxs)("defs", {
    children: [filteredYAxisIds.map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime6.jsxs)(React25.Fragment, {
...
var ChartsSvgLayer = React26.forwardRef(function ChartsSvgLayer2(inProps, ref) {
  const {
    store
  } = useChartsContext();
  ...
  return (0, import_jsx_runtime7.jsxs)(ChartsSvgLayerStyles, _extends({
    viewBox: `0 0 ${svgWidth} ${svgHeight}`,
    className: clsx_default(classes.root, className)
  }, other, {
    ref,
    "aria-hidden": true,
    children: [(0, import_jsx_runtime7.jsx)(ChartsAxesGradients, {}), hasIntrinsicSize && children]
  }));
});
...
function useRegisterPointerInteractions() {
  ...
  const store = useStore2();
  const interactionActive = React27.useRef(false);
  const lastItemRef = React27.useRef(void 0);
  React27.useEffect(() => {
    const element = chartsLayerContainerRef.current;
    if (!element) {
      return void 0;
...
function useDescription() {
  ...
  const descriptionGetter = (_b = seriesConfig[type]) == null ? void 0 : _b.descriptionGetter;
...
function ChartsAccessibilityProxy() {
  ...
  const chartId = useChartId2();
  const currentFormatRef = React28.useRef(null);
  const currentIndexRef = React28.useRef(0);
...
var _excluded4 = ["children", "title", "desc", "className"];
...
var ChartsLayerContainer = React29.forwardRef(function ChartsLayerContainer2(inProps, ref) {
  const {
    store,
    instance
  } = useChartsContext();
  ...
  return (
    ...
    (0, import_jsx_runtime9.jsxs)(ChartsLayerContainerDiv, _extends({
      ref: handleRef,
      ownerState: {
        width: propsWidth,
        height: propsHeight
      ...
      children: [isKeyboardNavigationEnabled && (0, import_jsx_runtime9.jsx)(ChartsAccessibilityProxy, {}), desc && (0, import_jsx_runtime9.jsx)("span", {
        id: descId,
        style: {
          display: "none"
        },
...
var _excluded5 = ["children", "className", "title", "desc"];
var ChartsSurface = React30.forwardRef(function ChartsSurface2(inProps, ref) {
  const themeProps = useThemeProps({
    props: inProps,
  ...
  const classes = useUtilityClasses2();
  return (0, import_jsx_runtime10.jsx)(ChartsLayerContainer, {
    className: clsx_default(classes.root, className),
    ref,
    title,
    desc,
    children: (0, import_jsx_runtime10.jsx)(ChartsSvgLayer, _extends({}, other, {
      children
    }))
  });
});
...
function useIsHydrated() {
  return React31.useSyncExternalStore(emptySubscribe, getSnapshot, getServerSnapshot);
}
...
export {
  ...
  selectorChartsTooltipItemPosition2 as selectorChartsTooltipItemPosition,
  useChartHighlight,
  ChartsProvider,
  useChartsContext,
...
use-sync-external-store/cjs/use-sync-external-store-shim/with-selector.development.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-HYEP3Q23.js.map
