import {
  getReactElementRef
} from "./chunk-6KZZYQIA.js";
import {
  IconButton_default
} from "./chunk-ETXHJYOM.js";
import {
  Button_default
} from "./chunk-PBCBCWN4.js";
import {
  ButtonBase_default,
  setRef
} from "./chunk-WFSQGUS2.js";
import "./chunk-O2L7UIAB.js";
import {
  ...
  selectorChartSeriesConfigGetter,
  ...
  warnOnce,
  wiggle_default
} from "./chunk-HYEP3Q23.js";
import "./chunk-ROZNPSNB.js";
import {
  useLazyRef
} from "./chunk-5UXJCJXX.js";
import {
  getToggleButtonUtilityClass,
  toggleButtonClasses_default,
  useThemeProps
} from "./chunk-XTLDZ4A6.js";
import {
  refType_default
} from "./chunk-4MHUMIIC.js";
import {
  ownerDocument,
  useEventCallback_default
} from "./chunk-XQ5JJZFX.js";
import "./chunk-SJPGM2KE.js";
import {
  require_react_dom
} from "./chunk-NUMECXU6.js";
import "./chunk-JNGJ445P.js";
import {
  appendOwnerState_default,
  mergeSlotProps_default,
  resolveComponentProps_default
} from "./chunk-NVDXYKNL.js";
import "./chunk-2EAJV7YI.js";
import "./chunk-VPJMGHLD.js";
import {
  useForkRef
} from "./chunk-GM54TQNA.js";
import {
...
var _excluded4 = ["ownerState", "skipAnimation", "seriesId", "dataIndex", "xOrigin", "yOrigin"];
...
var _excluded5 = ["seriesId", "dataIndex", "classes", "color", "slots", "slotProps", "style", "onClick", "skipAnimation", "layout", "x", "xOrigin", "y", "yOrigin", "width", "height", "hidden"];
...
true ? BarElement.propTypes = {
  ...
  seriesId: import_prop_types3.default.string.isRequired,
...
var MemoFadedHighlightedBars = React10.memo(FadedHighlightedBars);
...
var _excluded8 = ["className", "skipAnimation", "onItemClick", "borderRadius", "renderer"];
...
function ChartsSingleXAxisTicks(inProps) {
  ...
  return (0, import_jsx_runtime11.jsx)(React13.Fragment, {
...
function ChartsXAxisImpl(_ref) {
  ...
  return (0, import_jsx_runtime13.jsxs)(XAxisRoot, {
    ...
    }, slotProps == null ? void 0 : slotProps.axisLine)), children, label && (0, import_jsx_runtime13.jsx)("g", {
      className: classes.label,
    ...
    children: yTicks.map((item, index) => {
      ...
      return (0, import_jsx_runtime16.jsxs)("g", {
        ...
        children: [!disableTicks && !ignoreTick && showTick && (0, import_jsx_runtime16.jsx)(Tick, _extends({
          x2: tickXSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), tickLabel !== void 0 && (0, import_jsx_runtime16.jsx)(TickLabel, _extends({
          x: labelPositionX,
          y: yTickLabel
        }, axisTickLabelProps, {
          style: _extends({}, axisTickLabelProps.style, groupConfig.tickLabelStyle),
...
true ? ChartsYAxis.propTypes = {
   ...
   * @default 0
   */
  tickSpacing: import_prop_types6.default.number
} : void 0;
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime19.jsxs)(React20.Fragment, {
    children: [xAxisIds.map((axisId) => {
      ...
      return (0, import_jsx_runtime19.jsx)(XAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
      ...
      return (0, import_jsx_runtime19.jsx)(YAxis, {
        slots,
        slotProps,
        axisId
      }, axisId);
...
var _excluded13 = ["type", "markShape", "color", "className", "classes"];
...
var ChartsLabelMark = consumeThemeProps("MuiChartsLabelMark", {
  ...
  return (0, import_jsx_runtime22.jsx)(Root, _extends({
    ...
    children: typeof Component === "function" ? (0, import_jsx_runtime22.jsx)(Component, {
      ...
      children: [type === "circle" && (0, import_jsx_runtime22.jsx)("svg", {
        viewBox: "0 0 15 15",
        children: (0, import_jsx_runtime22.jsx)("circle", {
          className: classes == null ? void 0 : classes.fill,
          r: "7.5",
          cx: "7.5",
          cy: "7.5",
      ...
      }), type === "line" && (0, import_jsx_runtime22.jsx)("svg", {
        viewBox: "0 0 16 8",
      ...
      }), type === "line+mark" && (0, import_jsx_runtime22.jsxs)("svg", {
        viewBox: "0 0 16 16",
        preserveAspectRatio: "none",
        children: [(0, import_jsx_runtime22.jsx)("path", {
          className: classes == null ? void 0 : classes.fill,
          ...
          strokeLinecap: "round",
          vectorEffect: "non-scaling-stroke"
        }), markShape && (0, import_jsx_runtime22.jsx)("path", {
      ...
      }), type !== "line" && type !== "circle" && type !== "line+mark" && (0, import_jsx_runtime22.jsx)("svg", {
        viewBox: "0 0 13 13",
    ...
    return (0, import_jsx_runtime23.jsx)(ChartsTooltipPaper, {
      ...
      children: (0, import_jsx_runtime23.jsxs)(ChartsTooltipTable, {
        ...
        children: [(0, import_jsx_runtime23.jsxs)(Typography_default, {
          ...
          children: (0, import_jsx_runtime23.jsx)(Content2, {
            classes: propClasses,
            item: tooltipData
          })
        })]
  ...
  return (0, import_jsx_runtime23.jsx)(ChartsTooltipPaper, {
    ...
    children: (0, import_jsx_runtime23.jsx)(ChartsTooltipTable, {
      ...
      children: (0, import_jsx_runtime23.jsx)("tbody", {
        children: (0, import_jsx_runtime23.jsx)(Content, {
          classes: propClasses,
          item: (
...
function DefaultMultipleValueContent({
  ...
  return (0, import_jsx_runtime23.jsx)(React24.Fragment, {
    children: item.values.map((value) => (0, import_jsx_runtime23.jsxs)(ChartsTooltipRow, {
...
true ? DefaultMultipleValueContent.propTypes = {
  ...
  item: import_prop_types9.default.shape({
    ...
    identifier: import_prop_types9.default.shape({
      dataIndex: import_prop_types9.default.number,
      seriesId: import_prop_types9.default.string.isRequired,
      type: import_prop_types9.default.oneOf(["radar"]).isRequired
    }).isRequired,
    label: import_prop_types9.default.string,
    markShape: import_prop_types9.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]),
    markType: import_prop_types9.default.oneOfType([import_prop_types9.default.oneOf(["circle", "line", "line+mark", "square"]), import_prop_types9.default.func]),
    values: import_prop_types9.default.arrayOf(import_prop_types9.default.shape({
      formattedValue: import_prop_types9.default.string,
      label: import_prop_types9.default.string,
      markShape: import_prop_types9.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]),
      markType: import_prop_types9.default.oneOfType([import_prop_types9.default.oneOf(["circle", "line", "line+mark", "square"]), import_prop_types9.default.func]),
...
true ? DefaultSingleValueContent.propTypes = {
  ...
  item: import_prop_types9.default.shape({
    color: import_prop_types9.default.string.isRequired,
    formattedValue: import_prop_types9.default.any.isRequired,
    identifier: import_prop_types9.default.shape({
      dataIndex: import_prop_types9.default.number,
      seriesId: import_prop_types9.default.string.isRequired,
      type: import_prop_types9.default.oneOf(["bar", "line", "pie", "radar", "scatter"]).isRequired
    }).isRequired,
    label: import_prop_types9.default.string,
    markShape: import_prop_types9.default.oneOf(["circle", "cross", "diamond", "square", "star", "triangle", "wye"]),
    markType: import_prop_types9.default.oneOfType([import_prop_types9.default.oneOf(["circle", "line", "line+mark", "square"]), import_prop_types9.default.func]),
  ...
  Object.keys(series).filter((seriesType) => composableCartesianSeriesTypes.has(seriesType)).forEach((seriesType) => {
    ...
    return seriesOfType.seriesOrder.forEach((seriesId) => {
      ...
      if (tooltipItemIndex >= 0) {
        ...
        const color = ((_a = colorProcessors[seriesType]) == null ? void 0 : _a.call(colorProcessors, seriesToAdd, xAxis[providedXAxisId], yAxis[providedYAxisId], colorAxisId ? zAxis[colorAxisId] : void 0)(dataIndex)) ?? "";
  ...
  Object.keys(series).filter(isPolarSeriesType).forEach((seriesType) => {
    ...
    return seriesOfType.seriesOrder.forEach((seriesId) => {
      ...
      if (tooltipItemIndex >= 0) {
        ...
        const color = ((_a = colorProcessors[seriesType]) == null ? void 0 : _a.call(colorProcessors, seriesToAdd, providedRotationAxisId !== void 0 ? rotationAxis[providedRotationAxisId] : void 0, providedRadiusAxisId !== void 0 ? radiusAxis[providedRadiusAxisId] : void 0)(dataIndex)) ?? "";
  ...
  return (0, import_jsx_runtime24.jsx)(ChartsTooltipPaper, {
    ...
    children: tooltipData.map(({
      ...
      const sortedItems = sort && sort !== "none" ? [...seriesItems].sort((a, b) => {
        var _a, _b;
        const aValue = (_a = a.value) == null ? void 0 : _a.valueOf();
      ...
      return (0, import_jsx_runtime24.jsxs)(ChartsTooltipTable, {
        ...
        children: [axisValue != null && !mainAxis.hideTooltip && (0, import_jsx_runtime24.jsx)(Typography_default, {
          ...
          children: sortedItems.map((item) => {
            ...
            return (0, import_jsx_runtime24.jsx)(Content, {
...
true ? DefaultContent.propTypes = {
  ...
  item: import_prop_types10.default.shape({
    ...
    formattedLabel: import_prop_types10.default.string,
    ...
    value: import_prop_types10.default.oneOfType([import_prop_types10.default.number, import_prop_types10.default.shape({
      colorValue: import_prop_types10.default.any,
      id: import_prop_types10.default.oneOfType([import_prop_types10.default.number, import_prop_types10.default.string]),
      sizeValue: import_prop_types10.default.any,
      x: import_prop_types10.default.number.isRequired,
      y: import_prop_types10.default.number.isRequired,
      z: import_prop_types10.default.any
    })])
  }).isRequired
} : void 0;
true ? ChartsAxisTooltipContent.propTypes = {
   ...
   * @default 'none'
   */
  sort: import_prop_types10.default.oneOf(["asc", "desc", "none"]),
...
var PopperTooltip = React27.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  const resolvedAnchorElement = React27.useMemo(() => resolveAnchorEl(anchorEl), [anchorEl]);
  React27.useEffect(() => {
...
function ChartsTooltipContainer(inProps) {
  ...
  const seriesConfig = store.use(selectorChartSeriesConfig);
  const selectorItemPosition = tooltipItem && ((_b = seriesConfig[tooltipItem.type]) == null ? void 0 : _b.selectorTooltipItemPosition) || selectorChartsTooltipItemPosition;
  ...
  const pointerAnchorEl = React30.useMemo(() => ({
  ...
  return (0, import_jsx_runtime27.jsxs)(React30.Fragment, {
    children: [chartsLayerContainerRef.current && ReactDOM2.createPortal((0, import_jsx_runtime27.jsx)("div", {
      ref: setAnchorEl,
      style: {
        position: "absolute",
        display: "hidden",
...
true ? ChartsTooltipContainer.propTypes = {
   ...
   * @default 'pointer'
   */
  anchor: import_prop_types15.default.oneOf(["chart", "node", "pointer"]),
  /**
   * An HTML element, [virtualElement](https://popper.js.org/docs/v2/virtual-elements/),
   * or a function that returns either.
   * It's used to set the position of the popper.
   ...
   * so it's simply `document.body` most of the time.
   */
  container: import_prop_types15.default.oneOfType([(props, propName) => {
   ...
   * A ref that points to the used popper instance.
   */
  popperRef: import_prop_types15.default.oneOfType([import_prop_types15.default.func, import_prop_types15.default.shape({
    current: import_prop_types15.default.shape({
      destroy: import_prop_types15.default.func.isRequired,
      forceUpdate: import_prop_types15.default.func.isRequired,
      setOptions: import_prop_types15.default.func.isRequired,
      state: import_prop_types15.default.shape({
        attributes: import_prop_types15.default.object.isRequired,
        elements: import_prop_types15.default.object.isRequired,
        modifiersData: import_prop_types15.default.object.isRequired,
        options: import_prop_types15.default.object.isRequired,
        orderedModifiers: import_prop_types15.default.arrayOf(import_prop_types15.default.object).isRequired,
        placement: import_prop_types15.default.oneOf(["auto-end", "auto-start", "auto", "bottom-end", "bottom-start", "bottom", "left-end", "left-start", "left", "right-end", "right-start", "right", "top-end", "top-start", "top"]).isRequired,
        rects: import_prop_types15.default.object.isRequired,
        reset: import_prop_types15.default.bool.isRequired,
        scrollParents: import_prop_types15.default.object.isRequired,
        strategy: import_prop_types15.default.oneOf(["absolute", "fixed"]).isRequired,
        styles: import_prop_types15.default.object.isRequired
      }).isRequired,
      update: import_prop_types15.default.func.isRequired
    })
  })]),
  /**
...
var _excluded15 = ["classes", "trigger", "sort"];
function ChartsTooltip(props) {
  const {
    classes: propClasses,
    trigger = "axis",
    sort
  } = props, containerProps = _objectWithoutPropertiesLoose(props, _excluded15);
  const classes = useUtilityClasses5(propClasses);
...
true ? ChartsTooltip.propTypes = {
   ...
   * @default 'pointer'
   */
  anchor: import_prop_types16.default.oneOf(["chart", "node", "pointer"]),
  /**
   * An HTML element, [virtualElement](https://popper.js.org/docs/v2/virtual-elements/),
   * or a function that returns either.
   * It's used to set the position of the popper.
   ...
   * @default 'none'
   */
  sort: import_prop_types16.default.oneOf(["asc", "desc", "none"]),
  /**
   * The system prop that allows defining system overrides as well as additional CSS styles.
   */
...
var consumeSlots = (name, slotPropName, options, InComponent) => {
  ...
  return React31.forwardRef(ConsumeSlotsInternal);
};
...
var _excluded18 = ["direction", "onItemClick", "className", "classes", "toggleVisibilityOnClick"];
...
}, React33.forwardRef(function ChartsLegend2(props, ref) {
...
true ? ChartsLegend.propTypes = {
   ...
   * @default false
   */
  toggleVisibilityOnClick: import_prop_types18.default.bool
} : void 0;
...
true ? ChartsLabelGradient.propTypes = {
   ...
   * @default 'horizontal'
   */
  direction: import_prop_types19.default.oneOf(["vertical", "horizontal"]),
  /**
   * A unique identifier for the gradient.
   * The `gradientId` will be used as `fill="url(#gradientId)"`.
   */
  gradientId: import_prop_types19.default.string.isRequired,
  /**
   ...
   */
  rotate: import_prop_types19.default.bool,
  /**
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'end'
   */
  labelPosition: import_prop_types20.default.oneOf(["start", "end", "extremes"]),
  /**
   ...
   * Useful for linear gradients that are not in the correct orientation.
   */
  rotateGradient: import_prop_types20.default.bool,
  /**
   * The thickness of the gradient
   * @default 12
   */
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'extremes'
   */
  labelPosition: import_prop_types21.default.oneOf(["start", "end", "extremes", "inline-start", "inline-end"]),
  /**
   * The type of the mark.
   * @default 'square'
   */
  markType: import_prop_types21.default.oneOf(["square", "circle", "line"]),
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<HTMLButtonElement, MouseEvent>} event The click event.
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime39.jsx)(React40.Fragment, {
    children: xTicks.map(({
      ...
      var _a;
      return !instance.isXInside(offset2) ? null : (0, import_jsx_runtime39.jsx)(GridLine, {
        y1: start2,
        y2: end2,
        x1: offset2,
        x2: offset2,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime40.jsx)(React41.Fragment, {
    children: yTicks.map(({
      ...
      var _a;
      return !instance.isYInside(offset2) ? null : (0, import_jsx_runtime40.jsx)(GridLine, {
        y1: offset2,
        y2: offset2,
        x1: start2,
        x2: end2,
...
var _excluded27 = ["className", "vertical", "horizontal"];
...
// node_modules/@mui/x-charts/BarChart/useBarChartProps.mjs
var _excluded28 = ["xAxis", "yAxis", "series", "width", "height", "margin", "colors", "dataset", "sx", "axisHighlight", "grid", "children", "slots", "slotProps", "skipAnimation", "loading", "layout", "onItemClick", "highlightedItem", "onHighlightChange", "borderRadius", "className", "hideLegend", "showToolbar", "brushConfig", "renderer"];
var useBarChartProps = (props) => {
  ...
  const defaultBandXAxis = React43.useMemo(() => [{
  ...
  const defaultBandYAxis = React43.useMemo(() => [{
  ...
  const seriesWithDefault = React43.useMemo(() => series.map((s) => _extends({
    type: "bar"
  }, s, {
    layout: hasHorizontalSeries ? "horizontal" : "vertical"
  })), [hasHorizontalSeries, series]);
  const defaultXAxis = hasHorizontalSeries ? void 0 : defaultBandXAxis;
  const processedXAxis = React43.useMemo(() => {
    if (!xAxis) {
      return defaultXAxis;
    }
  ...
  const processedYAxis = React43.useMemo(() => {
    if (!yAxis) {
      return defaultYAxis;
    }
...
var ToggleButtonGroupContext = React44.createContext({});
if (true) {
...
var ToggleButtonGroupButtonContext = React45.createContext(void 0);
if (true) {
...
var ToggleButton = React46.forwardRef(function ToggleButton2(inProps, ref) {
  const {
    value: contextValue,
    ...contextProps
  } = React46.useContext(ToggleButtonGroupContext_default);
  const toggleButtonGroupButtonContextPositionClassName = React46.useContext(ToggleButtonGroupButtonContext_default);
...
function getValidReactChildren(children) {
  return React47.Children.toArray(children).filter((child) => React47.isValidElement(child));
}
...
var ChartsSlotsContext = React49.createContext(null);
if (true) ChartsSlotsContext.displayName = "ChartsSlotsContext";
function useChartsSlots() {
  const context = React49.useContext(ChartsSlotsContext);
  if (context == null) {
...
var getValueExtremum = (direction) => (params) => {
  ...
  return Object.keys(series).filter((seriesId) => {
    ...
    const [seriesMin, seriesMax] = (stackedDataToUse == null ? void 0 : stackedDataToUse.reduce((seriesAcc, values, index) => {
...
function createGetNextIndexFocusedItem(compatibleSeriesTypes, allowCycles = false, useCurrentSeriesMaxLength = false) {
  return function getNextIndexFocusedItem(currentItem, state) {
    ...
    const maxLength = useCurrentSeriesMaxLength ? ((_b = (_a = processedSeries[type]) == null ? void 0 : _a.series[seriesId]) == null ? void 0 : _b.data.length) ?? 0 : getMaxSeriesLength(processedSeries, compatibleSeriesTypes);
...
function collectCurvePoints(data, getPixelX, getPixelY, left2, right2, connectNulls) {
  const points = [];
  if (connectNulls) {
  ...
  let start2 = left2;
  while (start2 > 0 && data[start2 - 1] != null) {
    start2 -= 1;
  }
  let end2 = right2;
  while (end2 < data.length - 1 && data[end2 + 1] != null) {
    end2 += 1;
  }
...
function getItemAtPosition(state, point) {
  ...
  for (const seriesId of series.seriesOrder) {
    ...
    if (!connectNulls && (data[left2] == null || data[right2] == null)) {
      continue;
    }
    ...
    if (left2 === right2) {
      const yValue = (_b = visibleStackedData[left2]) == null ? void 0 : _b[1];
      if (yValue == null) {
        continue;
      }
      ...
      const distance2 = Math.abs(point.y - yPosition2);
  ...
  for (let g = stackingGroups.length - 1; g >= 0; g -= 1) {
    ...
    for (let i = 0; i < groupIds.length; i += 1) {
      ...
      if ((data[left2] == null || data[right2] == null) && !connectNulls) {
        continue;
      }
      const xScale = xAxis.scale;
      const yScale = yAxis.scale;
      ...
      if (point.y >= yMin && point.y <= yMax) {
        ...
        return {
          type: "line",
          seriesId,
          dataIndex: dataIndex === -1 ? left2 : dataIndex
        };
      }
    }
  }
...
var selectorProgressivePlans = createSelector(selectorProgressiveState, (s) => s == null ? void 0 : s.plans);
var selectorProgressiveRevealedRounds = createSelector(selectorProgressiveState, (s) => (s == null ? void 0 : s.revealedRounds) ?? 0);
function getSeriesPointCount(processedSeries, seriesId) {
  ...
  for (const type in processedSeries) {
    ...
    const item = (_a = processedSeries[type]) == null ? void 0 : _a.series[seriesId];
    if (item) {
...
var selectorProgressiveSeriesRevealedBatches = createSelector(selectorProgressiveAggregate, selectorProgressiveRevealedRounds, selectorChartZoomIsInteracting, function selectorProgressiveSeriesRevealedBatches2(agg, revealed, isInteracting, seriesId) {
...
var _excluded29 = ["children", "localeText", "plugins", "slots", "slotProps", "seriesConfig"];
...
true ? ChartsDataProvider.propTypes = {
  ...
  apiRef: import_prop_types27.default.shape({
    current: import_prop_types27.default.any
  }),
  /**
   ...
   */
  experimentalFeatures: import_prop_types27.default.any,
  /**
   ...
   */
  series: import_prop_types27.default.arrayOf(import_prop_types27.default.object),
  /**
   * If `true`, animations are skipped.
...
function useComponentRenderer(defaultElement, render, props, state = {}) {
  ...
  if (render) {
    ...
    return React53.cloneElement(render, props);
  }
  return React53.createElement(defaultElement, props);
}
...
var ToolbarContext = React54.createContext(void 0);
if (true) ToolbarContext.displayName = "ToolbarContext";
function useToolbarContext() {
  const context = React54.useContext(ToolbarContext);
  if (context === void 0) {
...
function ToolbarContextProvider({
  ...
  const [focusableItemId, setFocusableItemId] = React54.useState(null);
  const focusableItemIdRef = React54.useRef(focusableItemId);
  const [items, setItems] = React54.useState([]);
  const getSortedItems = React54.useCallback(() => items.sort(sortByDocumentPosition), [items]);
  const findEnabledItem = React54.useCallback((startIndex, step, wrap = true) => {
    var _a, _b;
  ...
  const registerItem = React54.useCallback((id, itemRef) => {
  ...
  const onItemKeyDown = React54.useCallback((event) => {
    var _a;
    if (!focusableItemId) {
      return;
    }
  ...
  const onItemFocus = React54.useCallback((id) => {
    if (focusableItemId !== id) {
      setFocusableItemId(id);
    }
  }, [focusableItemId, setFocusableItemId]);
  const onItemDisabled = React54.useCallback((id) => {
    var _a;
    const sortedItems = getSortedItems();
...
function useRegisterToolbarButton(props, ref) {
  ...
  const previousDisabled = React55.useRef(disabled);
  React55.useEffect(() => {
  ...
  const previousAriaDisabled = React55.useRef(ariaDisabled);
  React55.useEffect(() => {
...
var _excluded31 = ["className", "render"];
...
var Toolbar = React56.forwardRef(function Toolbar2(_ref, ref) {
  let {
    className,
    render
...
var _excluded32 = ["render", "onKeyDown", "onFocus", "disabled", "aria-disabled"];
var _excluded210 = ["tabIndex"];
var ToolbarButton = React57.forwardRef(function ToolbarButton2(props, ref) {
  const {
    render
...
var _excluded33 = ["children", "sx", "extendVertically", "hideLegend", "legendDirection", "legendPosition"];
...
var ChartsWrapper = React58.forwardRef(function ChartsWrapper2(props, ref) {
  const {
    children,
    sx,
    extendVertically,
  ...
  return (0, import_jsx_runtime52.jsx)(Root3, _extends({
    ref: handleRef,
    ownerState,
    sx,
...
true ? ChartsWrapper.propTypes = {
   ...
   */
  extendVertically: import_prop_types30.default.bool,
  /**
   ...
   * @default 'horizontal'
   */
  legendDirection: import_prop_types30.default.oneOf(["horizontal", "vertical"]),
  /**
   * The position of the legend.
   * @default { horizontal: 'center', vertical: 'bottom' }
   */
  legendPosition: import_prop_types30.default.shape({
    horizontal: import_prop_types30.default.oneOf(["center", "end", "start"]),
    vertical: import_prop_types30.default.oneOf(["bottom", "middle", "top"])
  }),
...
function FocusedBar(props) {
  ...
  return (0, import_jsx_runtime53.jsx)("rect", _extends({
    fill: "none",
    stroke: (theme.vars ?? theme).palette.text.primary,
    strokeWidth: 2,
    x: x - 3,
...
var BarChart = React60.forwardRef(function BarChart2(inProps, ref) {
  var _a, _b, _c, _d;
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  ...
  return (0, import_jsx_runtime54.jsx)(ChartsDataProvider, _extends({}, chartsDataProviderProps, {
    children: (0, import_jsx_runtime54.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      ref,
      children: [props.showToolbar && Toolbar3 ? (0, import_jsx_runtime54.jsx)(Toolbar3, _extends({}, (_c = props.slotProps) == null ? void 0 : _c.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime54.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime54.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime54.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime54.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime54.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime54.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime54.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), (0, import_jsx_runtime54.jsx)(FocusedBar, {})]
        })), (0, import_jsx_runtime54.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime54.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime54.jsx)(Tooltip, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.tooltip))]
    }))
  }));
});
...
true ? BarChart.propTypes = {
   ...
   * @default 0
   */
  axesGap: import_prop_types31.default.number,
  /**
   ...
   */
  disableKeyboardNavigation: import_prop_types31.default.bool,
  /**
   * Options to enable features planned for the next major.
   */
  experimentalFeatures: import_prop_types31.default.object,
  /**
   ...
   * ```
   */
  hiddenItems: import_prop_types31.default.arrayOf(import_prop_types31.default.oneOfType([import_prop_types31.default.shape({
    dataIndex: import_prop_types31.default.number,
    seriesId: import_prop_types31.default.string.isRequired,
    type: import_prop_types31.default.oneOf(["bar"]).isRequired
  }), import_prop_types31.default.shape({
    dataIndex: import_prop_types31.default.number,
    seriesId: import_prop_types31.default.string.isRequired,
    type: import_prop_types31.default.oneOf(["bar"])
  })]).isRequired),
  /**
   * If `true`, the legend is not rendered.
   */
   ...
   */
  highlightedItem: import_prop_types31.default.oneOfType([import_prop_types31.default.shape({
    dataIndex: import_prop_types31.default.number,
    seriesId: import_prop_types31.default.string.isRequired
  }), import_prop_types31.default.shape({
    dataIndex: import_prop_types31.default.number,
   ...
   * ```
   */
  initialHiddenItems: import_prop_types31.default.arrayOf(import_prop_types31.default.oneOfType([import_prop_types31.default.shape({
    dataIndex: import_prop_types31.default.number,
    seriesId: import_prop_types31.default.string.isRequired,
    type: import_prop_types31.default.oneOf(["bar"]).isRequired
  }), import_prop_types31.default.shape({
   ...
   */
  onHiddenItemsChange: import_prop_types31.default.func,
  /**
   ...
   * @param {AxisItemIdentifier[]} axisItems The array of axes item identifiers.
   */
  onTooltipAxisChange: import_prop_types31.default.func,
  /**
   * The callback fired when the tooltip item changes.
   *
   * @param {SeriesItemIdentifier<SeriesType> | null} tooltipItem  The newly highlighted item.
   */
  onTooltipItemChange: import_prop_types31.default.func,
  /**
   * The type of renderer to use for the bar plot.
   * - `svg-single`: Renders every bar in a `<rect />` element.
   * - `svg-batch`: Batch renders bars in `<path />` elements for better performance with large datasets, at the cost of some limitations.
   ...
   * Identified by the axis id, and data index.
   */
  tooltipAxis: import_prop_types31.default.arrayOf(import_prop_types31.default.shape({
    axisId: import_prop_types31.default.oneOfType([import_prop_types31.default.number, import_prop_types31.default.string]).isRequired,
    dataIndex: import_prop_types31.default.number.isRequired
  })),
  /**
   ...
   */
  tooltipItem: import_prop_types31.default.oneOfType([import_prop_types31.default.shape({
    dataIndex: import_prop_types31.default.number.isRequired,
    seriesId: import_prop_types31.default.string.isRequired
  }), import_prop_types31.default.shape({
    dataIndex: import_prop_types31.default.number.isRequired,
   ...
   */
  xAxis: import_prop_types31.default.arrayOf(import_prop_types31.default.object),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types31.default.arrayOf(import_prop_types31.default.object)
} : void 0;
export {
  BAR_CHART_PLUGINS,
  BarChart,
