import {
  ...
  setRef,
  useId_default
} from "./chunk-BJQSNCEY.js";
import {
  appendOwnerState_default,
  mergeSlotProps_default,
  resolveComponentProps_default
} from "./chunk-FTFCEOSW.js";
import {
  createSimplePaletteValueFilter
} from "./chunk-XNNHBD7O.js";
import {
  ...
  warnOnce,
  wiggle_default
} from "./chunk-Y7LTAUMB.js";
import {
  getToggleButtonUtilityClass,
  toggleButtonClasses_default,
  useThemeProps
} from "./chunk-AHVVBZF4.js";
import {
  useLazyRef
} from "./chunk-LS7FH3X3.js";
import {
  ownerDocument,
  refType_default,
  useEventCallback_default
} from "./chunk-27OGTVG7.js";
import "./chunk-VPJMGHLD.js";
import {
  chainPropTypes,
  useForkRef
} from "./chunk-QEVDKKA4.js";
import "./chunk-HNJP3IIZ.js";
import {
  _extends,
  capitalize_default,
  clsx_default,
...
var PopperTooltip = React28.forwardRef(function PopperTooltip2(props, forwardedRef) {
  ...
  const resolvedAnchorElement = React28.useMemo(() => resolveAnchorEl(anchorEl), [anchorEl]);
  React28.useEffect(() => {
...
function ChartsTooltipContainer(inProps) {
  ...
  const pointerAnchorEl = React31.useMemo(() => ({
...
var useBarChartProps = (props) => {
  ...
  const defaultBandXAxis = React44.useMemo(() => [{
  ...
  const defaultBandYAxis = React44.useMemo(() => [{
  ...
  const seriesWithDefault = React44.useMemo(() => series.map((s) => _extends({
    type: "bar"
  }, s, {
    layout: hasHorizontalSeries ? "horizontal" : "vertical"
  })), [hasHorizontalSeries, series]);
  const defaultXAxis = hasHorizontalSeries ? void 0 : defaultBandXAxis;
  const processedXAxis = React44.useMemo(() => {
    if (!xAxis) {
      return defaultXAxis;
    }
  ...
  const processedYAxis = React44.useMemo(() => {
    if (!yAxis) {
      return defaultYAxis;
    }
...
var ToggleButton = React48.forwardRef(function ToggleButton2(inProps, ref) {
  ...
  return (0, import_jsx_runtime46.jsx)(ToggleButtonRoot, {
...
function getValidReactChildren(children) {
  return React49.Children.toArray(children).filter((child) => React49.isValidElement(child));
}
...
var ToggleButtonGroup = React50.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  ...
  return (0, import_jsx_runtime47.jsx)(ToggleButtonGroupRoot, {
    role: "group",
    className: clsx_default(classes.root, className),
    ref,
    ownerState,
    ...other,
    children: (0, import_jsx_runtime47.jsx)(ToggleButtonGroupContext_default.Provider, {
      value: context,
      children: validChildren.map((child, index) => {
        ...
        return (0, import_jsx_runtime47.jsx)(ToggleButtonGroupButtonContext_default.Provider, {
...
function useChartsSlots() {
  const context = React51.useContext(ChartsSlotsContext);
  if (context == null) {
...
function ChartsSlotsProvider(props) {
  ...
  return (0, import_jsx_runtime48.jsx)(ChartsSlotsContext.Provider, {
    value,
    children
  });
}
...
function ChartsDataProvider(props) {
  ...
  return (0, import_jsx_runtime49.jsx)(ChartsProvider, _extends({}, chartProviderProps, {
    children: (0, import_jsx_runtime49.jsx)(ChartsLocalizationProvider, {
      localeText,
      children: (0, import_jsx_runtime49.jsx)(ChartsSlotsProvider, {
        slots,
        slotProps,
...
true ? ChartsDataProvider.propTypes = {
  ...
  apiRef: import_prop_types28.default.shape({
    current: import_prop_types28.default.any
  }),
  /**
   ...
   */
  experimentalFeatures: import_prop_types28.default.any,
  /**
   ...
   */
  series: import_prop_types28.default.arrayOf(import_prop_types28.default.object),
  /**
   * If `true`, animations are skipped.
...
function useComponentRenderer(defaultElement, render, props, state = {}) {
  ...
  if (render) {
    ...
    return React55.cloneElement(render, props);
  }
  return React55.createElement(defaultElement, props);
}
...
var ToolbarContext = React56.createContext(void 0);
if (true) ToolbarContext.displayName = "ToolbarContext";
function useToolbarContext() {
  const context = React56.useContext(ToolbarContext);
  if (context === void 0) {
...
function ToolbarContextProvider({
  ...
  const [focusableItemId, setFocusableItemId] = React56.useState(null);
  const focusableItemIdRef = React56.useRef(focusableItemId);
  const [items, setItems] = React56.useState([]);
  const getSortedItems = React56.useCallback(() => items.sort(sortByDocumentPosition), [items]);
  const findEnabledItem = React56.useCallback((startIndex, step, wrap = true) => {
    var _a, _b;
  ...
  const registerItem = React56.useCallback((id, itemRef) => {
  ...
  const onItemKeyDown = React56.useCallback((event) => {
    var _a;
    if (!focusableItemId) {
      return;
    }
  ...
  const onItemFocus = React56.useCallback((id) => {
    if (focusableItemId !== id) {
      setFocusableItemId(id);
    }
  }, [focusableItemId, setFocusableItemId]);
  const onItemDisabled = React56.useCallback((id) => {
    var _a;
    const sortedItems = getSortedItems();
  ...
  return (0, import_jsx_runtime50.jsx)(ToolbarContext.Provider, {
    value: contextValue,
    children
  });
}
...
function useRegisterToolbarButton(props, ref) {
  ...
  const previousDisabled = React57.useRef(disabled);
  React57.useEffect(() => {
  ...
  const previousAriaDisabled = React57.useRef(ariaDisabled);
  React57.useEffect(() => {
...
var Toolbar = React58.forwardRef(function Toolbar2(_ref, ref) {
  let {
    className,
    render
  ...
  return (0, import_jsx_runtime51.jsx)(ToolbarContextProvider, {
    children: element
  });
});
...
var ToolbarButton = React59.forwardRef(function ToolbarButton2(props, ref) {
  const {
    render
...
var ChartsWrapper = React60.forwardRef(function ChartsWrapper2(props, ref) {
  const {
    children,
    sx,
    extendVertically,
  ...
  const ownerState = React60.useMemo(() => ({
    hideLegend,
    legendDirection,
    legendPosition
  }), [hideLegend, legendDirection, legendPosition]);
  return (0, import_jsx_runtime53.jsx)(Root3, _extends({
    ref: handleRef,
    ownerState,
    sx,
...
function FocusedBar(props) {
  ...
  return (0, import_jsx_runtime54.jsx)("rect", _extends({
    fill: "none",
    stroke: (theme.vars ?? theme).palette.text.primary,
    strokeWidth: 2,
    x: x - 3,
...
var BarChart = React62.forwardRef(function BarChart2(inProps, ref) {
  var _a, _b, _c, _d;
  const props = useThemeProps({
    props: inProps,
    name: "MuiBarChart"
  ...
  return (0, import_jsx_runtime55.jsx)(ChartsDataProvider, _extends({}, chartsDataProviderProps, {
    children: (0, import_jsx_runtime55.jsxs)(ChartsWrapper, _extends({}, chartsWrapperProps, {
      ref,
      children: [props.showToolbar && Toolbar3 ? (0, import_jsx_runtime55.jsx)(Toolbar3, _extends({}, (_c = props.slotProps) == null ? void 0 : _c.toolbar)) : null, !props.hideLegend && (0, import_jsx_runtime55.jsx)(ChartsLegend, _extends({}, legendProps)), (0, import_jsx_runtime55.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
        children: [(0, import_jsx_runtime55.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime55.jsxs)("g", _extends({}, clipPathGroupProps, {
          children: [(0, import_jsx_runtime55.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime55.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime55.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps)), (0, import_jsx_runtime55.jsx)(FocusedBar, {})]
        })), (0, import_jsx_runtime55.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime55.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
      })), !props.loading && (0, import_jsx_runtime55.jsx)(Tooltip, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.tooltip))]
    }))
  }));
});
